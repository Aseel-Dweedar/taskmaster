...
public final class Team implements Model {
  ...
  private final @ModelField(targetType="TaskTodo") @HasMany(associatedWith = "taskTeam", type = TaskTodo.class) List<TaskTodo> taskTodo = null;
  ...
  public List<TaskTodo> getTaskTodo() {
      return taskTodo;
  }
